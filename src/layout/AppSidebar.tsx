...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Add Slider", path: "/add-slider", pro: false },
    ],
  },
  {
    icon: <BoxCubeIcon />,
    name: "Banner",
    subItems: [
      { name: "Banner List", path: "/banner-list", pro: false },
      { name: "Add Banner", path: "/add-banner", pro: false },
    ],
  },
  {
    icon: <BoxCubeIcon />,
  ...
  },
  {
    ...
    name: "Sub Category",
    subItems: [
      { name: "Sub Category List", path: "/sub-category-list", pro: false },
  ...
  },
  {
    ...
    name: "Small Category",
    subItems: [
      { name: " Small Category List", path: "/small-category-list", pro: false },
      { name: "Add Small Category", path: "/add-small-category", pro: false },
    ],
  },
  {
    icon: <BoxCubeIcon />,
